...
const Home = () => {
  // uses dummy data, add Context API later
  return (
    <div className='py-12 px-26 flex flex-col gap-10 justify-center items-center'>
      <div id="welcome-message" className='flex flex-col justify-center items-center gap-1'>
        ...
        <p className='text-lg font-semibold text-text-muted'>Friday, August 1, 2025</p>
        <p className='text-md font-semibold text-accent'>08:42 PM</p>
      </div>
